  ...
  return (
    <main>
      <div className='hero-text-container'>
        ...
        <Link href="/offerings">Click for Current Offerings</Link>
      </div>
      ...
      <div className='row-p'>
        ...
        <p>If you want to join our early supporters list, please fill out our <Link href="https://app.deform.cc/form/dcdc8d6b-1d3f-4745-83f9-8fb8783e70c6" target="_blank">Deform(click)</Link></p>
